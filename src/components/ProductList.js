...
const Products = () => {
  const products =  [{ id: 1, name: 'Broche de Coração', price: 10.99 },
  { id: 2, name: 'Broche de Estrela', price: 8.99 },
  { id: 3, name: 'Broche de Flor', price: 12.99 }
];
  return (
      ...
      {products.map(product => (
        ...
        <img class="hover:grow hover:shadow-lg" src="https://images.unsplash.com/photo-1555982105-d25af4182e4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&h=400&q=80" alt=""></img>
          <div class="pt-3 flex items-center justify-between">
            <h3>{product.name}</h3>
            <p class="pt-1 text-gray-900">Preço: R${product.price.toFixed(2)}</p>
