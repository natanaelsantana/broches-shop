      ...
      <nav id="header" className="w-full z-30 top-0 py-1">
        <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
          ...
          <div className="container mx-auto flex flex-wrap items-center justify-between px-6 py-3">
            <div className="flex items-center order-2 md:order-1" id="menu">
          ...
          <div className="order-1 md:order-2">
              <input type="text" placeholder="Pesquisar" className="rounded-full border border-gray-300 py-1 px-3 focus:outline-none focus:border-indigo-500"/>
          </div>
            ...
            <div className="order-2 md:order-3 flex items-center" id="nav-content">
                ...
                <a className="inline-block no-underline hover:text-black" href="/">
                    <svg className="fill-current hover:text-black" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <circle fill="none" cx="12" cy="7" r="3" />ws
